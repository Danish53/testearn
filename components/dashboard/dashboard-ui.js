...
export const DASH = {
  wrap: "mx-auto w-full min-w-0 max-w-6xl space-y-4 sm:space-y-6",
  ...
  lead: "mt-1 text-xs leading-relaxed text-slate-400 sm:text-base",
  card: "rounded-2xl border border-white/[0.08] bg-[#0b1018]/85 p-4 shadow-xl shadow-black/50 ring-1 ring-white/[0.05] backdrop-blur-md sm:p-6",
  cardMuted:
  ...
  grid2: "grid grid-cols-1 gap-3 min-[400px]:grid-cols-2 sm:gap-4",
