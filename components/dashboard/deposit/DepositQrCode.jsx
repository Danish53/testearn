...
export default function DepositQrCode({ address, networkLabel }) {
  if (!address) {
    return (
      <div className="flex h-[220px] w-[220px] flex-col items-center justify-center rounded-2xl border border-dashed border-white/15 bg-white/[0.03] p-4 text-center text-xs text-slate-500">
