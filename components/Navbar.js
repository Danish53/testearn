...
function SunMark({ className = "" }) {
  return (
    ...
    >
      <svg
        viewBox="0 0 24 24"
        className="h-5 w-5 text-solar-sun"
        fill="currentColor"
      >
    ...
    >
      <div className="mx-auto flex h-14 min-h-[3.5rem] max-w-7xl items-center justify-between gap-3 px-3 sm:h-16 sm:min-h-0 sm:px-5 md:px-6 lg:px-8">
        ...
        <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
          <Link
            href="/dashboard"
            className="inline-flex min-h-[40px] max-w-[5.5rem] items-center justify-center truncate rounded-full border border-solar-border px-2.5 py-2 text-[11px] font-semibold text-solar-text transition hover:border-solar-accent/50 hover:text-solar-accent sm:max-w-none sm:px-3.5 sm:text-sm"
          ...
          <Link
            href="/login"
            className="group inline-flex items-center gap-1.5 rounded-full bg-solar-text px-3.5 py-2 text-xs font-semibold text-solar-foreground-on-accent transition hover:bg-white min-h-[40px] sm:gap-2 sm:px-5 sm:text-sm md:text-[0.9375rem]"
          >
            Login
            <span
              aria-hidden
